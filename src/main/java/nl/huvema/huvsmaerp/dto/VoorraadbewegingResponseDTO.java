...
public class VoorraadbewegingResponseDTO {
    ...
    // Constructors
    public VoorraadbewegingResponseDTO() {}

    public VoorraadbewegingResponseDTO(String id, String productId, MutatieType mutatieType, 
                                      Integer aantal, LocalDate datum, String opmerking) {
        this.id = id;
